...
if __name__ == "__main__":
    # Example usage for reading CSV from GCS
    ...
    # Example usage for reading data from Azure SQL Server
    ...
    azure_query = "SELECT TOP 10 * FROM dbo.EmployeeData"  # Replace with your SQL query
    ...
    # Example usage for merging data and uploading to BigQuery
